...
public class ItemBlockRecyclerViewAdapter extends RecyclerView.Adapter<ItemBlockRecyclerViewAdapter.ItemViewHolder> {
    ...
    List<Integer> filterBlockId;
     Chip chip;
    Child child;
    List<Integer> getBlockedId = new ArrayList<>();
    ArrayList<SectionModel> sectionModels;


    public ItemBlockRecyclerViewAdapter(Context mContext, ArrayList<Child> arrayList, OnItemClick callback, List<Integer> filterBlockId,  ArrayList<SectionModel> sectionModels,Callcheck callcheck) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
     /*   LocalBroadcastManager.getInstance(mContext).registerReceiver(receiver,
                new IntentFilter("StatusReceiver"));*/
