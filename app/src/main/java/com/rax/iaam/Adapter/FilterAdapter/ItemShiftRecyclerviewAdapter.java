...
public class ItemShiftRecyclerviewAdapter extends RecyclerView.Adapter<ItemShiftRecyclerviewAdapter.ItemViewHolder> {
    private Context mContext;
    private ArrayList<ShiftChild> arrayList;
    private OnItemClick callback;
    public ArrayList<Integer> posBlockId = new ArrayList<>();
    public static  final String TAG="ItemShiftRecyclerview";
    public ArrayList<Integer> filterShiftId;
    Chip chip;
    ShiftChild child;
    List<Integer> ids = new ArrayList<>();
    private CallCheckShift callcheck;

    public ItemShiftRecyclerviewAdapter(Context mContext, ArrayList<ShiftChild> arrayList, OnItemClick callback, ArrayList<Integer> filterShiftId, CallCheckShift callcheck) {
...
ChipDrawable chipDrawable = ChipDrawable.createFromAttributes(mContext,
        ...
        chip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                  ...
                  callcheck.OnItemClickcheckShift(arrayList.get(position).getId(),arrayList.get(position).getParent_hierarchy_id());
 ...
 if(child.isChildCheck()){
    ...
    public void setData(List<ShiftChild> list) {
        if (getItemCount() != 0) {
            arrayList.clear();
        }
