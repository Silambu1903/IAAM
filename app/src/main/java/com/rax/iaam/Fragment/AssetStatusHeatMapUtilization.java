...
public class AssetStatusHeatMapUtilization extends Fragment {
    ...
    public AssetStatusHeatMapUtilization(List<JSONObject> upTimeCount, String utilization) {
